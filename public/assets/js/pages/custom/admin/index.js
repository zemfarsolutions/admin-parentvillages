			...
			columns: [
				{
					...
					autoHide: false,
					template: function(data) {
						var activeHref = '<a href="/admins/'+data.id+'/active" class=" btn btn-sm btn-outline-primary btn-text-primary btn-hover-primary btn-icon mr-2" title="Active Admin">\
												<i class="fas fa-user-check icon-sm"></i>\
											</a>\
											';
						var deactiveHref = '<a href="/admins/'+data.id+'/deactive" class=" btn btn-sm btn-outline-danger btn-text-deactive btn-hover-deactive btn-icon mr-2" title="Deactive Admin">\
												<i class="fas fa-user-slash icon-sm"></i>\
											</a>\
											';
						var editHref = '<a href="/admins/'+data.id+'/edit" class="btn btn-sm btn-outline-secondary btn-text-primary btn-hover-secondary btn-icon mr-2" title="Edit details">\
										...
										' ;
						var detailHref = '<a href="/employees/'+data.id+'/edit" class="btn btn-sm btn-outline-secondary btn-text-primary btn-hover-secondary btn-icon mr-2" title="View Admin Documents">\
