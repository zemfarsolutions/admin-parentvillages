...
@section('section')
    <div class="card card-custom card-stretch">
        ...
        <!--begin::Form-->
        <form class="form" action="/change-profile/{{Auth::user()->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Body-->
            <div class="card-body">
                <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{$user->avatar}})">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control form-control-lg form-control-solid" type="text" value="" name="last_name" />
                    </div>
                    <span class="text_danger">
                        @error('last_name')
                            {{ $message }}
