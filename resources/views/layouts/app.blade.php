...
<head>
    ...
    <meta charset="utf-8" />
    <title>@yield('title') | Parent Villages</title>
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <!--begin::Logo-->
        <a href="/">
            <img alt="Logo" src="../assets/media/logos/01.png" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item {{ gettype(strpos(url()->full(), '/')) == 'integer' ? 'menu-item-active' : null }}"
                                aria-haspopup="true">
                                <a href="/" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::ySvg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Layers.svg-->
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/admins')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-10-29-133027/theme/html/demo1/dist/../src/media/svg/icons/Communication/Contact1.svg-->
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/admins/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/admins/create" class="menu-link">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/admins')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/admins" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">View Admins List</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/employee')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-10-29-133027/theme/html/demo1/dist/../src/media/svg/icons/Communication/Contact1.svg-->
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/employees/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/employees')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/employees" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">View Employees List</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/users')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-10-29-133027/theme/html/demo1/dist/../src/media/svg/icons/Communication/Contact1.svg-->
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/users/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/users')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/users" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">View Users List</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/time-trackings')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/time-trackings/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/time-trackings')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/time-trackings" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">View Previous Records</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/mileage-logs')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/mileage-logs/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/mileage-logs')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/mileage-logs" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">View Mileage Logs</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/receipts')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Files/Upload.svg-->
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/receipts/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/receipts')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/expenses')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Files/Upload.svg-->
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/expenses/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/expenses')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/evaluations')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Files/Upload.svg-->
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/evaluations/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/evaluations')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                            ...
                            <li class="menu-section">
                                <h4 class="menu-text">Clients Management</h4>
                                <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                            </li>
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/intakes')) == 'integer' ? 'menu-item-open' : null }}"
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/intakes/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/intakes/create" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                <span class="menu-text">New Intake</span>
                                            </a>
                                        </li>
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/intakes')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                            ...
                            <li class="menu-item {{ gettype(strpos(url()->full(), '/applicants')) == 'integer' ? 'menu-item-active' : null }}"
                                aria-haspopup="true">
                                <a href="/applicants" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Layers.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                                                        ...
                                                        <ul class="menu-subnav">
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="/scholarships/create" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Add Scholarships</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="/scholarships" class="menu-link">
                                                        ...
                                                        <ul class="menu-subnav">
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="/admin/documents/create" class="menu-link">
                                                                    ...
                                                                    <span class="menu-text">Add Resources</span>
                                                                </a>
                                                            </li>
                                                            <li class="menu-item" aria-haspopup="true">
                                                                <a href="/admin/documents" class="menu-link">
                        ...
                        <div class="topbar">
                            <div class="topbar-item">
                                ...
                                <span class="symbol symbol-lg-35 symbol-25 symbol-light-success mr-3">
                                    <span class="symbol-label font-size-h5 font-weight-bold">{{ mb_substr(Auth::user()->name, 0, 1) }}</span>
                                </span>
                                    <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline">{{ strtok(Auth::user()->name, ' ') }}</span>
                                </div>
                            </div>
                            <!--end::User-->
                        </div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span class="navi-text text-muted">{{ Auth::user()->email }}</span>
                        </span>
...
<!-- Mirrored from preview.keenthemes.com/metronic/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 05:30:22 GMT -->
