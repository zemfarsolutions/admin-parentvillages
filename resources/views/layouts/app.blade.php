                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/users')) == 'integer' ? 'menu-item-open' : null }}"
                                ...
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span
                                        class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-10-29-133027/theme/html/demo1/dist/../src/media/svg/icons/Communication/Contact1.svg--><svg
