				...
				},
				{
					...
					template: function(data) {
						...
						var editHref = '<a href="/users/'+data.id+'/edit" class="btn btn-sm btn-outline-secondary btn-text-primary btn-hover-secondary btn-icon mr-2" title="Edit details">\
										...
										' ;
						var detailHref = '<a href="/users/'+data.id+'" class="btn btn-sm btn-outline-secondary btn-text-primary btn-hover-secondary btn-icon mr-2" title="View User Documents">\
