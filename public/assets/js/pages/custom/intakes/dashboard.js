...
var KTAppsUsersListDatatable = function() {
	...
	// basic demo
	var _demo = function() {
		var datatable = $('#intakes_datatable').KTDatatable({
			// datasource definition
			data: {
				type: 'remote',
				source: {
					read: {
						url: HOST_URL + 'api/get-limited-intakes',
						method: 'GET'
					},
				},
			...
			columns: [
				...
				},
				{
					...
					template: function(data) {
						return '\
                            <div class="d-flex">\
                                <a href="/intakes/'+data.id+'/view" class="btn btn-sm btn-outline-primary btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">\
                                    <i class="flaticon2-document"></i>\
                                </a>\
								<a href="/intakes/'+data.id+'/edit" class="btn btn-outline-secondary btn btn-sm btn-default btn-icon mr-2" title="Edit details">\
