	...
	var _demo = function() {
		var datatable = $('#kt_datatable').KTDatatable({
			...
			data: {
				...
				source: {
					read: {
						url: HOST_URL + 'api/get-employees',
						method: 'GET'
					},
				},
			...
			columns: [
				{
					...
					template: function(data) {
						return '\
	                        <a href="/employees/'+data.id+'/edit" class="btn btn-sm btn-outline-secondary btn-text-primary btn-hover-secondary btn-icon mr-2" title="Edit details">\
	                        ...
	                        <a href="/employees/'+data.id+'" class="btn btn-sm btn-outline-danger btn-text-primary btn-hover-danger btn-icon" title="Delete">\
								<span class="svg-icon svg-icon-md">\
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
											<rect x="0" y="0" width="24" height="24"/>\
