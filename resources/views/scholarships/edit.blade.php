                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">Edit Scholarship</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Edit Scholarships</h3>
                        </div>
                        <!--begin::Form-->
                        <form class="form" method="POST" action="/scholarships/{{ $scholarship->id }}">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Title:</label>
                                        <input name="title" value="{{ $scholarship->title }}" type="text"
                                            class="form-control" placeholder="Enter title" />
                                        <span class="form-text text-muted">Please enter title</span>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Short Description:</label>
                                        <input required value="{{ $scholarship->short_description }}"
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea name="full_description" class="form-control" cols="30" rows="10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input required value="{{ $scholarship->event_date }}" name="event_date"
