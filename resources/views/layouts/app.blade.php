                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/time-tracking')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/time-tracking/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/time-tracking/create" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/time-tracking')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/time-tracking" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/milaege-logs')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="#" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Milaege Logs</span>
                                    <i class="menu-arrow"></i>
                                </a>
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/milaege-logs/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/milaege-logs/create" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/milaege-logs')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/milaege-logs" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                            ...
                            <li class="menu-item {{ gettype(strpos(url()->full(), '/client/intake-form')) == 'integer' ? 'menu-item-active' : null }}"
                                aria-haspopup="true">
